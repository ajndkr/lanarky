...
_ws_chatbot_template = f"""<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <script>
        var endpoint = "{get_settings().websocket_url}{get_settings().websocket_endpoint}";
    ...
    <body class="bg-black">
        <div class="chat-body card">
            <div class="card-body p-5">
                <h4 class="card-title text-center text-xl font-medium">{get_settings().title}</h4>
...
def get_ws_template(request: Request):
    return _TemplateResponse(
        template=Template(_ws_chatbot_template), context={"request": request}
    )
